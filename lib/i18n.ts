export const translations = {
  ...
  ru: {
    ...
    hero: {
      ...
      mainHeading: "Осваивай английский в своем темпе с поддержкой наставника",
      subHeading: "",
      intro:
    ...
    whyItWorks: {
      ...
      testimonialLocation: "Студентка Емекн",
    ...
    features: {
      ...
      items: [
        ...
        {
          title: "Поддержка наставника-человека",
    ...
    comparison: {
      ...
      subtitle: "Сравните Emery с традиционными учителями английского и другими языковыми приложениями.",
      features: [
        {
          name: "Цена",
          emeryValue: "🪙🪙",
